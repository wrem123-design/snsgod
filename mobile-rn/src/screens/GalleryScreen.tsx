...
const styles = StyleSheet.create({
  ...
  tileMissing: { ...StyleSheet.absoluteFill, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceAlt },
  ...
  viewer: { ...StyleSheet.absoluteFill, zIndex: 10, backgroundColor: colors.modalSurface, padding: 12 },
  ...
  missingOverlay: { ...StyleSheet.absoluteFill, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceAlt },
  ...
  representativeModal: { ...StyleSheet.absoluteFill, zIndex: 20, padding: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.modalSurface },
