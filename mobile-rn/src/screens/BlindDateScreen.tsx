...
const styles = StyleSheet.create({
  ...
  encounterSuccessImageButton: { ...StyleSheet.absoluteFill },
  encounterSuccessImage: { ...StyleSheet.absoluteFill, width: '100%', height: '100%' },
  encounterSuccessShade: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(0,0,0,0.34)' },
  ...
  photoPreviewBackdrop: { ...StyleSheet.absoluteFill },
