...
const styles = StyleSheet.create({
  ...
  promptEditorOverlay: { ...StyleSheet.absoluteFill, zIndex: 35, backgroundColor: 'rgba(17,18,20,0.54)', padding: 14, justifyContent: 'center' },
  ...
  quickActionLayer: { ...StyleSheet.absoluteFill, zIndex: 26 },
