...
const styles = StyleSheet.create({
  ...
  imageViewerOverlay: { ...StyleSheet.absoluteFill, zIndex: 60, backgroundColor: 'rgba(0,0,0,0.92)', alignItems: 'center', justifyContent: 'center' },
  imageViewerBackdrop: { ...StyleSheet.absoluteFill },
  ...
  modal: { ...StyleSheet.absoluteFill, zIndex: 20, backgroundColor: 'rgba(0,0,0,0.38)', justifyContent: 'flex-end' },
